...
It tracks vjt's tree and modem stack unchanged and adds a lean
optimization layer on top — BBRv3, an eBPF/XDP/BTF platform with the
cake/bpf qdisc kmods and tools, PREEMPT_DYNAMIC + IKCONFIG, TCP/qdisc
sysctl baselines, WireGuard — nothing else. What, why and how to verify:
